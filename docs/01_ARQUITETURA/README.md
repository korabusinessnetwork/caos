...
- **Decisões arquiteturais grandes**: por quê React + TypeScript + Vite (PWA) · Supabase (auth/Postgres/RLS) · Vercel · Web Push, por quê não alternativa X
